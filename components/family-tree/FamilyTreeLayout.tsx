...
export const FamilyTreeLayout: React.FC<FamilyTreeLayoutProps> = ({ tree, persons, relationships, locations }) => {
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab !== 'overview' && (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 h-96 flex items-center justify-center">
            <p className="text-gray-500 dark:text-gray-400">Component rendering here</p>
          </div>
        )}
      </main>
    </div>
